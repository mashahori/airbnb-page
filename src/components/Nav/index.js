...
const Nav = () => (
  <nav className="nav">
    ...
    <button type="button" className="nav__button button">
      <InlineSVG className="nav__icon" src={lang} />
    </button>
    <button type="button" className="nav__user nav__button">
      <InlineSVG className="nav__icon" src={burger} />
      <InlineSVG src={user} />
    </button>
  </nav>
);
